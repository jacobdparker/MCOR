min_int = .001
  ...
  f = file_search('chianti/dem/custom_spectra/*.fits')

  images = moses1_eit_linemap(min_int,f[3],ions=ions,ar_wvl=wvl,ar_int=int)
  tri0 = {mag:0.0,images:images,ions:ions,wvl:wvl,int:int}
  STOP
