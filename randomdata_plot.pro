...
;zero_rand is the output random data of randomdata
;super_zero is an output exposure from moses_super_exposure

pro randomdata_plot,zero_rand,super_zero,super_plus,super_minus,alpha,start,auto=auto,power=power,stats=stats,window=window,unitvar=unitvar,disvar=disvar,subtract=subtract
...
window,0
cgplot,M_auto(k_alpha_m,*),color='red',xr = [0,1024],yr= [-1.,1.]
cgplot,M_auto(k_1minusalpha_m,*),color='red',/overplot
cgplot,median(m_auto,dimension=1),color='red',/overplot

cgplot,R_auto(*,k_alpha_r),/overplot
cgplot,R_auto(*,k_1minusalpha_r),/overplot
cgplot,median(r_auto,dimension=2),/overplot
cglegend,titles=['Moses Columns','Random Data'],colors=['red','black'],location=[.65,.85]
...
window,1
cgplot,M_power(k_alpha_m,*),color='red',/ylog
cgplot,M_power(k_1minusalpha_m,*),color='red',/overplot
cgplot,median(m_power,dimension=1),color='red',/overplot

cgplot,R_power(*,k_alpha_r),/overplot
cgplot,R_power(*,k_1minusalpha_r),/overplot
cgplot,median(r_power,dimension=2),/overplot
cglegend,titles=['Moses Columns','Random Data'],colors=['red','black'],location=[.5,.85]
